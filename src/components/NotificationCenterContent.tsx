  ...
  return (
    <div className="mt-8 rounded-2xl bg-white p-6 shadow-sm">
      <div className="flex flex-col justify-between gap-4 border-b pb-5 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-2 text-gray-600">
            Order, seller, payment, delivery, and marketplace updates will
            appear here.
          </p>
      ...
      {notifications.length === 0 ? (
        <p className="mt-6 text-gray-600">No notifications yet.</p>
      ) : (
              ...
              <div className="flex flex-col justify-between gap-3 md:flex-row">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-wide text-gray-500">
                    {notification.audience} · {notification.type}
                  </p>
                ...
                {!notification.isRead && (
                  <button
                    ...
                    className="h-fit rounded-lg bg-black px-4 py-2 text-sm text-white"
                  >
                    Mark Read
                  </button>
                )}
